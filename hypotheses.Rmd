...
mlr_model_transformed <- lm(price_transformed ~ living_in_m2 + bedrooms + grade + has_basement +
                              renovated + nice_view + perfect_condition + real_bathrooms +
...
hist(resid(mlr_model_transformed), breaks = 30, main = "Histogram of Residuals")
qqnorm(resid(mlr_model_transformed))
qqline(resid(mlr_model_transformed), col = "red")
